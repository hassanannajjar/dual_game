...
import { getName, setName } from './prefs.js?v=20';
import { nextRating, evalAchievements, ACHIEVEMENTS } from './logic.js?v=20';
import { earnForResult, grantAchievement, questEvent, getLevel, getStreak, renderLevelHeader, renderShop, renderQuests, renderStreak, renderGifts, owns, equip, REWARDS } from './loyalty.js?v=20';
import { getToken } from './identity.js?v=20';
