...
import { getName, setName } from './prefs.js?v=19';
import { nextRating, evalAchievements, ACHIEVEMENTS } from './logic.js?v=19';
import { earnForResult, grantAchievement, questEvent, getLevel, getStreak, renderLevelHeader, renderShop, renderQuests, renderStreak, renderGifts, owns, equip, REWARDS } from './loyalty.js?v=19';
import { getToken } from './identity.js?v=19';
