...
import { applyLang, getLang, t, onLangChange } from './i18n.js?v=22';
import { setSound, soundOn, setVolume, getVolume, setMusic, musicOn } from './sound.js?v=22';
import { owns, buy } from './loyalty.js?v=22';
