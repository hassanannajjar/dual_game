...
import { applyLang, getLang, t, onLangChange } from './i18n.js?v=38';
import { setSound, soundOn, setVolume, getVolume, setMusic, musicOn, setMusicMode, getMusicMode } from './sound.js?v=38';
import { owns, buy } from './loyalty.js?v=38';
