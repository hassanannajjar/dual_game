import { register, boot } from './platform.js?v=25';
import numberDuel from './games/number-duel.js?v=25';
import ticTacToe from './games/tic-tac-toe.js?v=25';
import connectFour from './games/connect-four.js?v=25';
import rps from './games/rock-paper-scissors.js?v=25';
import battleship from './games/battleship.js?v=25';
import gomoku from './games/gomoku.js?v=25';
import reversi from './games/reversi.js?v=25';
import checkers from './games/checkers.js?v=25';
import dots from './games/dots-boxes.js?v=25';
import uttt from './games/ultimate-ttt.js?v=25';
import mancala from './games/mancala.js?v=25';
import memory from './games/memory.js?v=25';
import morris from './games/nine-mens-morris.js?v=25';
import chess from './games/chess.js?v=25';
import hangman from './games/hangman.js?v=25';
import snakes from './games/snakes.js?v=25';
import pig from './games/pig.js?v=25';
import go from './games/go.js?v=25';
import order from './games/order-chaos.js?v=25';
import nim from './games/nim.js?v=25';
import yahtzee from './games/yahtzee.js?v=25';
import hex from './games/hex.js?v=25';
import ludo from './games/ludo.js?v=25';
import backgammon from './games/backgammon.js?v=25';
import chinesecheckers from './games/chinese-checkers.js?v=25';
import g2048 from './games/2048.js?v=25';
import tetris from './games/tetris.js?v=25';
import airhockey from './games/airhockey.js?v=25';
import tron from './games/tron.js?v=25';
import minesweeper from './games/minesweeper.js?v=25';
import snake from './games/snake.js?v=25';
import sudoku from './games/sudoku.js?v=25';
import sim from './games/sim.js?v=25';
import wordleDuel from './games/wordle-duel.js?v=25';
import farkle from './games/farkle.js?v=25';
import quarto from './games/quarto.js?v=25';
import mastermind from './games/mastermind.js?v=25';
import dominoes from './games/dominoes.js?v=25';
import wordRace from './games/word-race.js?v=25';
import match3 from './games/match3.js?v=25';
