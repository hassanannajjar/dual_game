import { register, boot } from './platform.js?v=31';
import numberDuel from './games/number-duel.js?v=31';
import ticTacToe from './games/tic-tac-toe.js?v=31';
import connectFour from './games/connect-four.js?v=31';
import rps from './games/rock-paper-scissors.js?v=31';
import battleship from './games/battleship.js?v=31';
import gomoku from './games/gomoku.js?v=31';
import reversi from './games/reversi.js?v=31';
import checkers from './games/checkers.js?v=31';
import dots from './games/dots-boxes.js?v=31';
import uttt from './games/ultimate-ttt.js?v=31';
import mancala from './games/mancala.js?v=31';
import memory from './games/memory.js?v=31';
import morris from './games/nine-mens-morris.js?v=31';
import chess from './games/chess.js?v=31';
import hangman from './games/hangman.js?v=31';
import snakes from './games/snakes.js?v=31';
import pig from './games/pig.js?v=31';
import go from './games/go.js?v=31';
import order from './games/order-chaos.js?v=31';
import nim from './games/nim.js?v=31';
import yahtzee from './games/yahtzee.js?v=31';
import hex from './games/hex.js?v=31';
import ludo from './games/ludo.js?v=31';
import backgammon from './games/backgammon.js?v=31';
import chinesecheckers from './games/chinese-checkers.js?v=31';
import g2048 from './games/2048.js?v=31';
import tetris from './games/tetris.js?v=31';
import airhockey from './games/airhockey.js?v=31';
import tron from './games/tron.js?v=31';
import minesweeper from './games/minesweeper.js?v=31';
import snake from './games/snake.js?v=31';
import sudoku from './games/sudoku.js?v=31';
import sim from './games/sim.js?v=31';
import wordleDuel from './games/wordle-duel.js?v=31';
import farkle from './games/farkle.js?v=31';
import quarto from './games/quarto.js?v=31';
import mastermind from './games/mastermind.js?v=31';
import dominoes from './games/dominoes.js?v=31';
import wordRace from './games/word-race.js?v=31';
import match3 from './games/match3.js?v=31';
