import { register, boot } from './platform.js?v=28';
import numberDuel from './games/number-duel.js?v=28';
import ticTacToe from './games/tic-tac-toe.js?v=28';
import connectFour from './games/connect-four.js?v=28';
import rps from './games/rock-paper-scissors.js?v=28';
import battleship from './games/battleship.js?v=28';
import gomoku from './games/gomoku.js?v=28';
import reversi from './games/reversi.js?v=28';
import checkers from './games/checkers.js?v=28';
import dots from './games/dots-boxes.js?v=28';
import uttt from './games/ultimate-ttt.js?v=28';
import mancala from './games/mancala.js?v=28';
import memory from './games/memory.js?v=28';
import morris from './games/nine-mens-morris.js?v=28';
import chess from './games/chess.js?v=28';
import hangman from './games/hangman.js?v=28';
import snakes from './games/snakes.js?v=28';
import pig from './games/pig.js?v=28';
import go from './games/go.js?v=28';
import order from './games/order-chaos.js?v=28';
import nim from './games/nim.js?v=28';
import yahtzee from './games/yahtzee.js?v=28';
import hex from './games/hex.js?v=28';
import ludo from './games/ludo.js?v=28';
import backgammon from './games/backgammon.js?v=28';
import chinesecheckers from './games/chinese-checkers.js?v=28';
import g2048 from './games/2048.js?v=28';
import tetris from './games/tetris.js?v=28';
import airhockey from './games/airhockey.js?v=28';
import tron from './games/tron.js?v=28';
import minesweeper from './games/minesweeper.js?v=28';
import snake from './games/snake.js?v=28';
import sudoku from './games/sudoku.js?v=28';
import sim from './games/sim.js?v=28';
import wordleDuel from './games/wordle-duel.js?v=28';
import farkle from './games/farkle.js?v=28';
import quarto from './games/quarto.js?v=28';
import mastermind from './games/mastermind.js?v=28';
import dominoes from './games/dominoes.js?v=28';
import wordRace from './games/word-race.js?v=28';
import match3 from './games/match3.js?v=28';
