import { register, boot } from './platform.js?v=26';
import numberDuel from './games/number-duel.js?v=26';
import ticTacToe from './games/tic-tac-toe.js?v=26';
import connectFour from './games/connect-four.js?v=26';
import rps from './games/rock-paper-scissors.js?v=26';
import battleship from './games/battleship.js?v=26';
import gomoku from './games/gomoku.js?v=26';
import reversi from './games/reversi.js?v=26';
import checkers from './games/checkers.js?v=26';
import dots from './games/dots-boxes.js?v=26';
import uttt from './games/ultimate-ttt.js?v=26';
import mancala from './games/mancala.js?v=26';
import memory from './games/memory.js?v=26';
import morris from './games/nine-mens-morris.js?v=26';
import chess from './games/chess.js?v=26';
import hangman from './games/hangman.js?v=26';
import snakes from './games/snakes.js?v=26';
import pig from './games/pig.js?v=26';
import go from './games/go.js?v=26';
import order from './games/order-chaos.js?v=26';
import nim from './games/nim.js?v=26';
import yahtzee from './games/yahtzee.js?v=26';
import hex from './games/hex.js?v=26';
import ludo from './games/ludo.js?v=26';
import backgammon from './games/backgammon.js?v=26';
import chinesecheckers from './games/chinese-checkers.js?v=26';
import g2048 from './games/2048.js?v=26';
import tetris from './games/tetris.js?v=26';
import airhockey from './games/airhockey.js?v=26';
import tron from './games/tron.js?v=26';
import minesweeper from './games/minesweeper.js?v=26';
import snake from './games/snake.js?v=26';
import sudoku from './games/sudoku.js?v=26';
import sim from './games/sim.js?v=26';
import wordleDuel from './games/wordle-duel.js?v=26';
import farkle from './games/farkle.js?v=26';
import quarto from './games/quarto.js?v=26';
import mastermind from './games/mastermind.js?v=26';
import dominoes from './games/dominoes.js?v=26';
import wordRace from './games/word-race.js?v=26';
import match3 from './games/match3.js?v=26';
