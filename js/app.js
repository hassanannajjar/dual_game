import { register, boot } from './platform.js?v=34';
import numberDuel from './games/number-duel.js?v=34';
import ticTacToe from './games/tic-tac-toe.js?v=34';
import connectFour from './games/connect-four.js?v=34';
import rps from './games/rock-paper-scissors.js?v=34';
import battleship from './games/battleship.js?v=34';
import gomoku from './games/gomoku.js?v=34';
import reversi from './games/reversi.js?v=34';
import checkers from './games/checkers.js?v=34';
import dots from './games/dots-boxes.js?v=34';
import uttt from './games/ultimate-ttt.js?v=34';
import mancala from './games/mancala.js?v=34';
import memory from './games/memory.js?v=34';
import morris from './games/nine-mens-morris.js?v=34';
import chess from './games/chess.js?v=34';
import hangman from './games/hangman.js?v=34';
import snakes from './games/snakes.js?v=34';
import pig from './games/pig.js?v=34';
import go from './games/go.js?v=34';
import order from './games/order-chaos.js?v=34';
import nim from './games/nim.js?v=34';
import yahtzee from './games/yahtzee.js?v=34';
import hex from './games/hex.js?v=34';
import ludo from './games/ludo.js?v=34';
import backgammon from './games/backgammon.js?v=34';
import chinesecheckers from './games/chinese-checkers.js?v=34';
import g2048 from './games/2048.js?v=34';
import tetris from './games/tetris.js?v=34';
import airhockey from './games/airhockey.js?v=34';
import tron from './games/tron.js?v=34';
import minesweeper from './games/minesweeper.js?v=34';
import snake from './games/snake.js?v=34';
import sudoku from './games/sudoku.js?v=34';
import sim from './games/sim.js?v=34';
import wordleDuel from './games/wordle-duel.js?v=34';
import farkle from './games/farkle.js?v=34';
import quarto from './games/quarto.js?v=34';
import mastermind from './games/mastermind.js?v=34';
import dominoes from './games/dominoes.js?v=34';
import wordRace from './games/word-race.js?v=34';
import match3 from './games/match3.js?v=34';
