import { register, boot } from './platform.js?v=27';
import numberDuel from './games/number-duel.js?v=27';
import ticTacToe from './games/tic-tac-toe.js?v=27';
import connectFour from './games/connect-four.js?v=27';
import rps from './games/rock-paper-scissors.js?v=27';
import battleship from './games/battleship.js?v=27';
import gomoku from './games/gomoku.js?v=27';
import reversi from './games/reversi.js?v=27';
import checkers from './games/checkers.js?v=27';
import dots from './games/dots-boxes.js?v=27';
import uttt from './games/ultimate-ttt.js?v=27';
import mancala from './games/mancala.js?v=27';
import memory from './games/memory.js?v=27';
import morris from './games/nine-mens-morris.js?v=27';
import chess from './games/chess.js?v=27';
import hangman from './games/hangman.js?v=27';
import snakes from './games/snakes.js?v=27';
import pig from './games/pig.js?v=27';
import go from './games/go.js?v=27';
import order from './games/order-chaos.js?v=27';
import nim from './games/nim.js?v=27';
import yahtzee from './games/yahtzee.js?v=27';
import hex from './games/hex.js?v=27';
import ludo from './games/ludo.js?v=27';
import backgammon from './games/backgammon.js?v=27';
import chinesecheckers from './games/chinese-checkers.js?v=27';
import g2048 from './games/2048.js?v=27';
import tetris from './games/tetris.js?v=27';
import airhockey from './games/airhockey.js?v=27';
import tron from './games/tron.js?v=27';
import minesweeper from './games/minesweeper.js?v=27';
import snake from './games/snake.js?v=27';
import sudoku from './games/sudoku.js?v=27';
import sim from './games/sim.js?v=27';
import wordleDuel from './games/wordle-duel.js?v=27';
import farkle from './games/farkle.js?v=27';
import quarto from './games/quarto.js?v=27';
import mastermind from './games/mastermind.js?v=27';
import dominoes from './games/dominoes.js?v=27';
import wordRace from './games/word-race.js?v=27';
import match3 from './games/match3.js?v=27';
